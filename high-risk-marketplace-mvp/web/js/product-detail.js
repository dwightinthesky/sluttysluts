...
const CATALOG = {
    'sample-lst-001': {
        ...
        currency: 'USD',
        promoted: true,
        description: 'Premium cotton set prepared immediately after training sessions and stored in sealed packaging. Discreet handling and private support included from checkout to delivery.',
    ...
    'sample-lst-002': {
        ...
        currency: 'USD',
        promoted: false,
        description: 'Curated everyday listing with priority packing and express handoff. Optimized for repeat buyers who value predictable quality and quick confirmation.',
    ...
    'sample-lst-003': {
        ...
        currency: 'USD',
        promoted: true,
        description: 'Limited collector listing with premium handling workflow, clear communication milestones, and authenticity-focused delivery flow for high-value orders.',
