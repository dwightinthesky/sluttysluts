      const I18N = {
        en: {
          ...
          descriptorCopy:
            'Your card statement will display: SS-TECH SERVICES. If this looks unfamiliar later, check your order first before filing a chargeback.',
      ...
      function setFieldError(id: string, message: string, show: boolean) {
      ...
      function boot() {
        ...
        if (profile) {
          (document.getElementById('firstName') as HTMLInputElement).value = String(profile.firstName || '');
          (document.getElementById('lastName') as HTMLInputElement).value = String(profile.lastName || '');
          (document.getElementById('email') as HTMLInputElement).value = String(profile.email || '');
          (document.getElementById('address') as HTMLInputElement).value = String(profile.address || '');
          if (typeof profile.discreet === 'boolean') state.discreet = profile.discreet;
        }
